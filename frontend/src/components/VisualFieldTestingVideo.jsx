    ...
    <div className="fixed inset-0 z-[200] flex flex-col md:items-center md:justify-center bg-[#020617] md:bg-black/95 md:backdrop-blur-xl overflow-y-auto md:overflow-hidden">
      ...
      <div className="md:hidden flex items-center justify-between px-6 py-4 border-b border-white/5 bg-[#0a0f1d]">
        ...
        <div className="flex flex-col items-center">
          <span className="text-[10px] font-black text-purple-500 uppercase tracking-[0.2em] mb-0.5">Clinical Module</span>
      ...
      <div className="relative w-full aspect-video md:max-w-6xl md:rounded-3xl overflow-hidden md:ring-1 md:ring-white/10 md:shadow-2xl shadow-indigo-500/10 shrink-0">
        ...
        <button 
          ...
          className="absolute top-6 right-6 md:right-20 z-50 p-3 bg-white/10 hover:bg-purple-500 hover:text-white rounded-full backdrop-blur-md transition-all text-white/70"
        ...
        {isPlaying && (
          <>
            <button 
              ...
              className="absolute top-6 right-20 md:right-32 z-50 p-3 bg-white/10 hover:bg-purple-500 hover:text-white rounded-full backdrop-blur-md transition-all text-white/70"
        ...
        {!isPlaying && currentScene === 0 && (
          <div className="absolute inset-0 z-40 flex flex-col items-center justify-center bg-black/60 bg-[url('/vf_video/vf_diagram.svg')] bg-cover bg-center">
            ...
            <div className="relative z-10 flex flex-col items-center text-center p-8">
              ...
              <span className="text-[10px] font-black text-purple-500 uppercase tracking-[0.4em] mb-4">Neural Assessment</span>
              <h2 className="text-2xl md:text-5xl text-white font-black mb-4 tracking-tighter uppercase italic">Visual Field Testing</h2>
              <p className="text-slate-400 font-medium max-w-lg mb-10 leading-relaxed text-sm md:text-base">An immersive clinical module demonstrating the standard assessment of the full visual field and automated perimetry mapping.</p>
              <button 
                onClick={handleStart}
                className="group bg-purple-500 hover:bg-white hover:text-purple-500 text-white px-10 py-5 rounded-2xl font-black shadow-2xl shadow-purple-500/20 transition-all transform active:scale-95 flex items-center justify-center gap-4 uppercase tracking-[0.2em] text-xs md:text-sm"
              >
            ...
            >
              <div className="bg-black/40 backdrop-blur-2xl p-6 md:p-10 rounded-[2rem] border border-white/5 shadow-2xl">
                <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-2 md:gap-4 mb-4">
                  <h3 className="text-purple-400 font-black uppercase tracking-[0.3em] text-[10px] md:text-xs italic">{currentData.title}</h3>
            ...
            <div className="hidden lg:flex flex-col gap-6 w-80 shrink-0">
              <div className="glass-card p-6 bg-purple-500/5 border-purple-500/20 rounded-3xl">
                <h4 className="text-white font-bold mb-2 italic flex items-center gap-2">
                  <Award size={16} className="text-purple-400" /> Clinical Metric
                </h4>
                <p className="text-xs text-slate-400 leading-relaxed font-medium">Mean Deviation (MD) and Pattern Standard Deviation (PSD) are critical indicators of glaucomatous field loss. Pay close attention to the pattern deviation plot.</p>
              </div>
            </div>
          </div>
        </div>
