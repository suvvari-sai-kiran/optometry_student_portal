    ...
    <div className="fixed inset-0 z-[200] flex flex-col md:items-center md:justify-center bg-[#020617] md:bg-black/95 md:backdrop-blur-xl overflow-y-auto md:overflow-hidden">
      ...
      <div className="relative w-full aspect-video md:max-w-6xl md:rounded-3xl overflow-hidden md:ring-1 md:ring-white/10 md:shadow-2xl shadow-indigo-500/10 shrink-0">
        ...
        {!isPlaying && currentScene === 0 && (
          <div className="absolute inset-0 z-40 flex flex-col items-center justify-center bg-black/60 bg-[url('/mag_video/mag_lens_text.svg')] bg-cover bg-center">
            ...
            <div className="relative z-10 flex flex-col items-center text-center p-8">
              ...
              <span className="text-[10px] font-black text-rose-500 uppercase tracking-[0.4em] mb-4">Calculation Module</span>
              <h2 className="text-2xl md:text-5xl text-white font-black mb-4 tracking-tighter uppercase italic">Magnification Test</h2>
              <p className="text-slate-400 font-medium max-w-lg mb-10 leading-relaxed text-sm md:text-base">An immersive clinical module demonstrating image enlargement math, proper optical formulae, and low vision prescriptions.</p>
              <button 
                onClick={handleStart}
            ...
            >
              <div className="bg-black/40 backdrop-blur-2xl p-6 md:p-10 rounded-[2rem] border border-white/5 shadow-2xl">
                <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-2 md:gap-4 mb-4">
                  <h3 className="text-rose-400 font-black uppercase tracking-[0.3em] text-[10px] md:text-xs">
                    Theoretical Concept: {currentData.title}
                  </h3>
            ...
            <div className="hidden lg:flex flex-col gap-6 w-80 shrink-0">
              <div className="glass-card p-6 bg-rose-500/5 border-rose-500/20 rounded-3xl">
                <h4 className="text-white font-bold mb-2 italic flex items-center gap-2">
                  <Award size={16} className="text-rose-400" /> Optical Note
                </h4>
                <p className="text-xs text-slate-400 leading-relaxed font-medium">Remember that linear magnification and angular magnification are different. For low vision aids, we primarily focus on relative distance magnification.</p>
              </div>
            </div>
          </div>
        </div>
