...
const SCRIPT = [
  { img: '/cs_video/scene_clinic.png', duration: 3000, title: 'Retinoscopy', text: 'Objective Refraction – Retinoscopy.', subtitle: 'Introduction' },
  { img: '/cs_video/scene_procedure.png', duration: 4000, title: '', text: 'To determine refractive error using light reflex.', subtitle: 'Objective Test' },
  { img: '/cs_video/scene_clinic.png', duration: 5000, title: '', text: 'A retinoscope projects light into the eye.', subtitle: 'Instrument' },
  { img: '/cs_video/scene_procedure.png', duration: 6000, title: '', text: 'Patient looks at a distant target. Examiner stands at working distance.', subtitle: 'Setup' },
  { img: '/cs_video/scene_clinic.png', duration: 8000, title: '', text: 'Observe the movement of reflex inside the pupil.', subtitle: 'Reflex' },
  { img: '/cs_video/scene_procedure.png', duration: 8000, title: '', text: 'Reflex moving with light indicates hyperopia.', subtitle: 'With Motion' },
  { img: '/cs_video/scene_procedure.png', duration: 8000, title: '', text: 'Reflex moving opposite indicates myopia.', subtitle: 'Against Motion' },
  { img: '/cs_video/scene_procedure.png', duration: 8000, title: '', text: 'Add lenses until reflex stops moving. This is neutralization.', subtitle: 'Neutralization' },
  { img: '/cs_video/scene_clinic.png', duration: 8000, title: '', text: 'Trial lenses are used to reach neutral point.', subtitle: 'Trial Lens Use' },
  { img: '/cs_video/scene_procedure.png', duration: 7000, title: '', text: 'Retinoscopy provides quick and accurate refractive assessment.', subtitle: 'Objective Refraction' }
];
...
export default function RetinoscopyVideo({ onClose, onStartTest }) {
    ...
    <div className="fixed inset-0 z-[200] bg-[#020617] flex flex-col overflow-hidden">
      <div className="shrink-0 flex items-center justify-between px-4 py-3 bg-[#0a0f1d]/95 backdrop-blur-sm border-b border-white/5 z-30">
        ...
        <div className="text-center">
          ...
          <h1 className="text-[13px] font-bold text-white uppercase tracking-wide">Retinoscopy</h1>
        </div>
      ...
      <div className="flex-1 overflow-y-auto">
          ...
          <AnimatePresence>
            {isIdle && (
              <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="absolute inset-0 flex flex-col items-center justify-center bg-[#020617] px-6 text-center z-20">
                ...
                <p className={`text-[9px] font-black uppercase tracking-[0.3em] mb-1.5 ${A.bright}`}>Objective Diagnostic Phase</p>
                <h2 className="text-lg sm:text-2xl text-white font-black tracking-tight uppercase italic mb-2">Retinoscopy</h2>
                <p className="text-slate-400 text-xs max-w-xs mb-5 leading-relaxed">Clinical module demonstrating objective refraction and reflex neutralization mechanics.</p>
        ...
        {isFinished && (
          <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4 }} className="px-4 pt-4 pb-6 sm:px-6 text-left">
            ...
            <p className="text-slate-400 text-sm leading-relaxed mb-4">Validate your knowledge on retinoscopy, neutrality, and refractive error detection with <strong className="text-white">10 clinical MCQs</strong>.</p>
            ...
            <div className={`mt-4 p-3.5 ${A.note} rounded-xl border`}>
              ...
              <ul className="text-slate-400 text-xs leading-relaxed list-disc list-inside mt-2 space-y-1">
                 <li>Ensure standard working distance is maintained exactly.</li>
                 <li>Correct working distance before documenting final refraction.</li>
                 <li>Watch for scissoring reflexes in irregular astigmatism.</li>
              </ul>
            </div>
          </motion.div>
        )}
