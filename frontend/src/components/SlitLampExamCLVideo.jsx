...
const A = { bar: 'bg-blue-500', glow: 'shadow-[0_0_18px_rgba(59,130,246,0.7)]', lbl: 'text-blue-400', bright: 'text-blue-500', btn: 'bg-blue-500 hover:bg-blue-400 shadow-blue-500/25', spin: 'bg-blue-500/20', bdr: 'border-blue-500/30 border-t-blue-400', note: 'bg-blue-500/5 border-blue-500/15', nIcon: 'text-blue-400' };
    ...
    <div className="fixed inset-0 z-[200] bg-[#020617] flex flex-col overflow-hidden">
      <div className="shrink-0 flex items-center justify-between px-4 py-3 bg-[#0a0f1d]/95 backdrop-blur-sm border-b border-white/5 z-30">
        ...
        <div className="text-center">
          ...
          <h1 className="text-[13px] font-bold text-white uppercase tracking-wide">Slit Lamp Exam</h1>
        </div>
      ...
      <div className="flex-1 overflow-y-auto">
          ...
          <AnimatePresence>
            {isIdle && (
              <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="absolute inset-0 flex flex-col items-center justify-center bg-[#020617] px-6 text-center z-20">
                ...
                <h2 className="text-lg sm:text-2xl text-white font-black tracking-tight uppercase italic mb-2">Slit Lamp Exam</h2>
                <p className="text-slate-400 text-xs max-w-xs mb-5 leading-relaxed">Clinical module demonstrating biomicroscopic assessment of lens fit and anterior segment health.</p>
        ...
        {isFinished && (
          <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4 }} className="px-4 pt-4 pb-6 sm:px-6">
            ...
            <p className="text-slate-400 text-sm leading-relaxed mb-4">Validate your knowledge on slit lamp examination with <strong className="text-white">10 clinical MCQs</strong>.</p>
            ...
            <div className={`mt-4 p-3.5 ${A.note} rounded-xl border`}>
              ...
              <p className="text-slate-400 text-xs leading-relaxed">The slit lamp requires mastering both illumination techniques and magnification to fully assess corneal health and microscopic lens deposits.</p>
            </div>
          </motion.div>
        )}
