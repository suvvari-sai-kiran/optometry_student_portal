      ...
      <div className="relative w-full max-w-6xl aspect-video bg-black rounded-3xl overflow-hidden ring-4 ring-white/10 shadow-2xl">
        ...
        {!isPlaying && currentScene === 0 && (
          <div className="absolute inset-0 z-40 flex flex-col items-center justify-center bg-black/60 bg-[url('/amsler_video/amsler_grid.svg')] bg-cover bg-center">
            ...
            <div className="relative z-10 flex flex-col items-center text-center p-8">
              ...
              <h2 className="text-4xl text-white font-black mb-4 tracking-tight">Amsler Grid Test Tutorial</h2>
              <p className="text-slate-400 font-medium max-w-lg mb-8">An immersive clinical module demonstrating the standard assessment of the central visual field and accurate detection of macular abnormalities.</p>
              <button 
                onClick={handleStart}
                className="bg-blue-500 hover:bg-blue-600 text-white px-10 py-5 rounded-2xl font-black shadow-2xl shadow-blue-500/30 transition-all transform active:scale-95 flex items-center justify-center gap-3 uppercase tracking-widest"
              >
            ...
            >
              <div className="bg-black/60 backdrop-blur-xl p-8 rounded-3xl border border-white/10 shadow-2xl">
                <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-4 mb-3">
                  <h3 className="text-blue-400 font-black uppercase tracking-[0.3em] text-sm md:text-base">{currentData.title}</h3>
        ...
        {!isPlaying && currentScene >= SCRIPT.length && (
          <div className="absolute inset-0 z-40 flex flex-col items-center justify-center bg-slate-900/90 backdrop-blur-sm">
            ...
            <p className="text-slate-400 font-medium mb-8">You have successfully reviewed the Amsler Grid Test procedure.</p>
            <div className="flex items-center gap-4">
              ...
              <button 
                onClick={onClose}
                className="bg-blue-500 hover:bg-blue-600 text-white px-8 py-4 rounded-xl font-bold transition-all shadow-lg"
              >
                Return to Clinic
              </button>
            </div>
