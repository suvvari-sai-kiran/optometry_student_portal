        ...
        {!isPlaying && currentScene === 0 && (
          <div className="absolute inset-0 z-40 flex flex-col items-center justify-center bg-black/60 bg-[url('/cs_video/scene_clinic.png')] bg-cover bg-center">
            ...
            <div className="relative z-10 flex flex-col items-center text-center p-8">
              ...
              <span className="text-[10px] font-black text-blue-400 uppercase tracking-[0.4em] mb-4">Fitting Mechanics</span>
              <h2 className="text-2xl md:text-5xl text-white font-black mb-4 tracking-tighter uppercase italic">Base Curve Selection</h2>
              <p className="text-slate-400 font-medium max-w-lg mb-10 leading-relaxed text-sm md:text-base">An immersive clinical module demonstrating the art and science of selecting the perfect base curve for optimal contact lens fit and patient comfort.</p>
              <button 
                onClick={handleStart}
            ...
            >
              <div className="bg-black/60 backdrop-blur-2xl p-6 md:p-10 rounded-[2rem] border border-white/5 shadow-2xl">
                <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-2 md:gap-4 mb-4">
                  <h3 className="text-blue-400 font-black uppercase tracking-[0.3em] text-[10px] md:text-xs italic">Phase {currentScene + 1}: {currentData.title}</h3>
          ...
          <div className="w-full p-8 md:p-12 text-center md:text-left md:flex md:items-center md:justify-between gap-12">
            <div className="flex-1">
              ...
              <p className="text-slate-400 text-sm md:text-lg font-medium leading-relaxed max-w-2xl mb-10">
                This assessment is related specifically to the Base Curve Selection procedures demonstrated above. You have **10 clinical MCQs** to validate your understanding.
              </p>
            ...
            <div className="hidden lg:flex flex-col gap-6 w-80 shrink-0">
              <div className="glass-card p-6 bg-blue-500/5 border-blue-500/20 rounded-3xl">
                <h4 className="text-white font-bold mb-2 italic flex items-center gap-2">
                  <Award size={16} className="text-blue-400" /> Fitting Tip
                </h4>
                <p className="text-xs text-slate-400 leading-relaxed font-medium">When evaluating the trial lens, always check for the 'push-up' effect. A healthy lens should readily move up when pushed from the lower lid and smoothly return to its central position.</p>
              </div>
            </div>
          </div>
        </div>
