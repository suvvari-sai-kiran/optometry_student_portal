        ...
        {!isPlaying && currentScene === 0 && (
          <div className="absolute inset-0 z-40 flex flex-col items-center justify-center bg-black/60 bg-[url('/cs_video/cs_scene_foggy_road.png')] bg-cover bg-center">
            ...
            <div className="relative z-10 flex flex-col items-center text-center p-8">
              ...
              <span className="text-[10px] font-black text-primary uppercase tracking-[0.4em] mb-4">Diagnostic Phase</span>
              <h2 className="text-2xl md:text-5xl text-white font-black mb-4 tracking-tighter uppercase italic">Contrast Sensitivity Test</h2>
              <p className="text-slate-400 font-medium max-w-lg mb-10 leading-relaxed text-sm md:text-base">An immersive clinical module demonstrating the crucial ability to distinguish objects from their background in low-contrast conditions.</p>
              <button 
                onClick={handleStart}
            ...
            >
              <div className="bg-black/40 backdrop-blur-2xl p-6 md:p-10 rounded-[2rem] border border-white/5 shadow-2xl">
                <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-2 md:gap-4 mb-4">
                  <h3 className="text-primary font-black uppercase tracking-[0.3em] text-[10px] md:text-xs italic">{currentData.title}</h3>
        ...
        <div className="w-full md:max-w-6xl md:mt-6 bg-[#0a0f1d] md:rounded-[2.5rem] overflow-hidden flex flex-col items-center animate-in fade-in slide-in-from-bottom-10 duration-700">
          ...
          <div className="w-full p-8 md:p-12 text-center md:text-left md:flex md:items-center md:justify-between gap-12">
            ...
            <div className="hidden lg:flex flex-col gap-6 w-80 shrink-0">
              <div className="glass-card p-6 bg-primary/5 border-primary/20 rounded-3xl">
                <h4 className="text-white font-bold mb-2 italic flex items-center gap-2">
                  <Award size={16} className="text-primary" /> Clinical Note
                </h4>
                <p className="text-xs text-slate-400 leading-relaxed font-medium">Contrast sensitivity is early evidence of pathological changes before acuity loss occurs. Ensure you follow the patient's reported faintest letters accurately.</p>
              </div>
            </div>
          </div>
        </div>
