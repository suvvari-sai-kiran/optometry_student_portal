...
export default function ContactLensPowerVideo({ onClose, onStartTest }) {
  ...
  return (
    <div className="fixed inset-0 z-[200] flex flex-col md:items-center md:justify-center bg-[#020617] md:bg-black/95 md:backdrop-blur-xl overflow-y-auto md:overflow-hidden font-sans">
      ...
      <div className="relative w-full aspect-video md:max-w-6xl md:rounded-3xl overflow-hidden md:ring-1 md:ring-white/10 md:shadow-2xl shadow-emerald-500/10 shrink-0">
        <button 
          onClick={onClose}
