...
import { Play, Pause, X, Eye, Volume2, VolumeX, Square, ChevronLeft, Clock, ClipboardCheck, Award, Maximize2, Glasses } from 'lucide-react';
            ...
            <div className="relative z-10 flex flex-col items-center text-center p-8">
              <div className="w-20 h-20 bg-emerald-500/20 rounded-full flex items-center justify-center border border-emerald-500/30 mb-8 border-t-emerald-400 animate-spin" style={{ animationDuration: '3s' }}>
                <div className="w-16 h-16 bg-emerald-500/20 rounded-full flex items-center justify-center animate-spin" style={{ animationDuration: '2s', animationDirection: 'reverse' }}>
                  <Glasses className="text-emerald-400 animate-pulse" size={32} />
                </div>
              </div>
              <span className="text-[10px] font-black text-emerald-400 uppercase tracking-[0.4em] mb-4">Dispensing Optics Suite</span>
              <h2 className="text-2xl md:text-5xl text-white font-black mb-4 tracking-tighter uppercase italic">Frame Selection Test</h2>
              <p className="text-slate-400 font-medium max-w-lg mb-10 leading-relaxed text-sm md:text-base">Comprehensive clinical guide to selecting the perfect spectacle frame based on facial morphology and prescription optics.</p>
              <button 
                onClick={handleStart}
            ...
            >
              <div className="bg-black/60 backdrop-blur-2xl p-6 md:p-10 rounded-[2rem] border border-white/5 shadow-2xl">
                <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-2 md:gap-4 mb-4">
                  <h3 className="text-emerald-400 font-black uppercase tracking-[0.3em] text-[10px] md:text-xs italic">Clinical Step {currentScene + 1}: {currentData.title}</h3>
          ...
          <div className="w-full p-8 md:p-12 text-center md:text-left md:flex md:items-center md:justify-between gap-12">
            <div className="flex-1">
              ...
              <p className="text-slate-400 text-sm md:text-lg font-medium leading-relaxed max-w-2xl mb-10">
                This assessment validates your proficiency in selecting spectacle frames based on professional clinical criteria. You have **10 clinical MCQs** to answer.
              </p>
            ...
            <div className="hidden lg:flex flex-col gap-6 w-80 shrink-0">
              <div className="glass-card p-6 bg-emerald-500/5 border-emerald-500/20 rounded-3xl">
                <h4 className="text-white font-bold mb-2 italic flex items-center gap-2">
                  <Award size={16} className="text-emerald-400" /> Clinical Pearl
                </h4>
                <p className="text-xs text-slate-400 leading-relaxed font-medium">To minimize lens thickness in high-minus prescriptions, select a frame with a small eye size and a central pupil alignment.</p>
              </div>
            </div>
          </div>
        </div>
