...
const SCRIPT = [
  {
    title: "Introduction",
    text: "Hello everyone! Today, we are going to learn about Lens Thickness Calculation in optometry.",
    duration: 5000,
    image: "/logo.png"
  },
  {
    title: "The Aim",
    text: "This calculation helps determine the thickness of a lens, which is important for comfort, appearance, and optical performance.",
    duration: 6000,
    image: "/ltc_video/thickness_types.svg"
  },
  {
    title: "Basic Concept",
    text: "Lens thickness depends on several factors such as lens power, diameter, material, and curvature.",
    duration: 6000,
    image: "/ltc_video/thickness_types.svg"
  },
  {
    title: "Types of Thickness",
    text: "There are two main types: Center thickness and edge thickness. Convex lenses are thicker at the center, while concave lenses are thicker at the edges.",
    duration: 7000,
    image: "/ltc_video/thickness_types.svg"
  },
  {
    title: "Formula Introduction",
    text: "A simplified formula is used to estimate lens thickness based on power and diameter.",
    duration: 5000,
    image: "/ltc_video/formula_display.svg"
  },
  {
    title: "The Formula",
    text: "The thickness is proportional to the power multiplied by the square of the diameter.",
    duration: 5000,
    image: "/ltc_video/formula_display.svg"
  },
  {
    title: "The Example",
    text: "For example, if lens power increases or the diameter becomes larger, the thickness of the lens also increases significantly.",
    duration: 7000,
    image: "/ltc_video/diameter_impact.svg"
  },
  {
    title: "Clinical Importance",
    text: "Understanding lens thickness helps in selecting the right frame, improving comfort, and reducing lens weight.",
    duration: 6000,
    image: "/logo.png"
  },
  {
    title: "Practical Tip",
    text: "To reduce thickness, smaller frames and high-index lens materials are often recommended.",
    duration: 6000,
    image: "/ltc_video/high_index_comparison.svg"
  },
  {
    title: "Conclusion",
    text: "So, lens thickness calculation is essential for both visual quality and patient comfort. Thank you for watching!",
    duration: 6000,
    image: "/logo.png"
  }
];
